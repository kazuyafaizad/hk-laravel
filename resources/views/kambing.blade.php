...
<head>
  ...
  <title>Husna Kitchen - Kambing Bakar Pilah #sekalighasonaklaie</title>
  <meta content="Kambing Bakar Pilah" name="description">
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+6013-607 2728</span></i>
        <i class="bi bi-clock d-flex align-items-center ms-4"><span> Mon-Sat: 12PM - 23PM</span></i>
      </div>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="fixed-top d-flex align-items-cente" style="margin-top:15px;">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between" style="max-height: 35px;" >
...
<!-- 
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Nak tau tak apa beza kambing bakar kami dengan Kedai Western lain ?</h3>
          
            <ul>
              <li><i class="bi bi-check-circle"></i> Daging Kambing bahagian LAMB SHOULDER yang lembut </li>
              <li><i class="bi bi-check-circle"></i> Perapan ISTIMEWA HOMEMADE yang betul betul PADUUU</li>
              <li><i class="bi bi-check-circle"></i> Sos lada Hitam HOMEMADE yang tak kan dijumpai di tempat lain</li>
            </ul>
            <p>
              Kambing kami di bakar menggunakan arang bagi menaikkan lagi aroma kambinng bakar, hampir kesemua menu kami di bakar menggunakan arang
            </p>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-3">
            ...
            @foreach($menu_special as $index => $row)
              <li class="nav-item">
              ...
              <div class="tab-pane @if($index==0) active show @endif" id="tab-{{$row['menu_id']}}">
                <div class="row">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>{{$row['menu_name']}}</h3>
                    <p class="fst-italic">RM {{$row['menu_price']}}</p>
    ...
    <section id="events" class="events">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Events</h2>
          <p>Menerima tempahan untuk majlis anda</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <img src="Restaurantly/assets/img/chefs/tokey.jpeg" class="img-fluid" alt="">
    ...
    <section id="contact" class="contact">
      ...
      <div data-aos="fade-up">
        <iframe style="border:0; width: 100%; height: 350px;" src="https://maps.google.com/maps?q=Kambing%20Bakar%20Pilah,%20Lorong%20Tbd%202/2,%20Kampung%20Batu%20Temensu,%20Kuala%20Pilah,%20Negeri%20Sembilan&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" allowfullscreen></iframe>
      </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>No. 73, Lorong TBD 2/2, Taman Bahagia Delima, 72000 Kuala Pilah, Negeri Sembilan. </p>
              </div>
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>kambingperapilah@gmail.com</p>
              </div>
  ...
  <footer id="footer">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <div class="social-links mt-3">
                ...
                <a href="https://www.facebook.com/KambingBakarPilah/" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/husnakitchenhq/" class="instagram"><i class="bx bxl-instagram"></i></a>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>FFF</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
