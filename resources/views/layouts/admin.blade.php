...
<head>
	...
	<meta name="author" content="Husna Kitchen Admin">
	<meta name="keywords" content="adminkit, bootstrap, bootstrap 5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">

	<link rel="preconnect" href="https://fonts.gstatic.com">
	<link rel="shortcut icon" href="img/icons/icon-48x48.png" />

	<title>Husna Kitchen Admin</title>
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
	          ...
	          <span class="align-middle">Husna Kitchen</span>
	        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{route('menu')}}">
			              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Menu</span>
			            </a>
					</li>
